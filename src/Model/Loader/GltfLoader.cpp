...
void GltfLoader::LoadModel(const std::string& _name, GESTD::WeakPtr<ResourceRepository> _repository) { 
    LoadGltf(ASSETS_FOLDER, _name, _repository);
}


void GltfLoader::LoadGltf(const std::string& _directory, const std::string& _name, const GESTD::WeakPtr<ResourceRepository> _repository) const {
