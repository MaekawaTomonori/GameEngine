...
void ModelCommon::Initialize(const GESTD::WeakPtr<DirectXAdapter>& _adapter, const GESTD::WeakPtr<DebugUI>& _debugUi) {
...
void ModelCommon::Initialize(const GESTD::WeakPtr<DirectXAdapter>& _adapter, const GESTD::WeakPtr<DebugUI>& _debugUi, GESTD::WeakPtr<ResourceRepository> _resource, SRVManager* _srv) {
    resource_ = _resource;
    srv_ = _srv;
