...
void SpriteInstance::UpdateMapData() const {
...
void SpriteInstance::ExecuteDraw() const {
...
const Vector2& SpriteInstance::GetPosition() const {
    return position_;
}

void SpriteInstance::SetPosition(const Vector2& _p) {
    position_ = _p;
}

const Vector2& SpriteInstance::GetSize() const {
    return size_;
}

void SpriteInstance::SetSize(const Vector2& _s) {
    size_ = _s;
}
...
void SpriteInstance::SetRotation(float _r) {
    rotation_ = _r;
}

const Vector4& SpriteInstance::GetColor() const {
    return material_->color;
}

void SpriteInstance::SetColor(const Vector4& _color) const {
    material_->color = _color;
}

const Vector2& SpriteInstance::GetAnchorPoint() const {
    return anchorPoint_;
}

void SpriteInstance::SetAnchorPoint(const Vector2& _a) {
    anchorPoint_ = _a;
}

bool SpriteInstance::IsFlipX() const {
    return flipX_;
}

void SpriteInstance::SetFlipX(bool _f) {
    flipX_ = _f;
}

bool SpriteInstance::IsFlipY() const {
    return flipY_;
}

void SpriteInstance::SetFlipY(bool _f) {
    flipY_ = _f;
}

const Vector2& SpriteInstance::GetTextureLeftTop() const {
    return leftTop_;
}

void SpriteInstance::SetTextureLeftTop(const Vector2& _textureLeftTop) {
    leftTop_ = _textureLeftTop;
}

const Vector2& SpriteInstance::GetTextureSize() const {
    return texSize_;
}

void SpriteInstance::SetTextureSize(const Vector2& _textureSize) {
    texSize_ = _textureSize;
}

void SpriteInstance::SetActivePostEffect(const bool _active) {
    posteffect_ = _active;
}
